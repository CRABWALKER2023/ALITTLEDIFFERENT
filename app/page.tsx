  ...
  return (
    <div style={{fontFamily:"'Cormorant Garamond', Georgia, serif",minHeight:'100vh',position:'relative',overflow:'hidden',background:'#f9f8f5'}}>
      <style>{`
        ...
        .size-box:hover { background:#fff !important; border-color:#3d5c35 !important; }
      `}</style>
      ...
      <div style={{position:'relative',zIndex:1}}>
        ...
        <nav style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'14px 40px',borderBottom:'0.5px solid #c8d8c0'}}>
          <div style={{display:'flex',gap:'28px'}}>
            {['HOME','SHOP','OUR STORY','CONTACT'].map(link => (
              <span key={link} className="nav-link" style={{fontSize:'11px',letterSpacing:'2.5px',color:'#3d5c35',cursor:'pointer'}}>{link}</span>
            ))}
          </div>
          <div style={{fontSize:'11px',letterSpacing:'2px',color:'#3d5c35'}}>EST. 1984</div>
        </nav>

        <section style={{textAlign:'center',padding:'56px 32px 44px'}}>
          <p style={{fontSize:'11px',letterSpacing:'3px',color:'#3d5c35',margin:'0 0 10px'}}>HANDMADE IN ITALY</p>
          ...
          <p style={{fontSize:'13px',letterSpacing:'2px',color:'#3d5c35',fontStyle:'italic'}}>Italian fabrics · Exceptional craftsmanship</p>
        </section>

        <section style={{padding:'0 40px 56px'}}>
          <p style={{textAlign:'center',fontSize:'11px',letterSpacing:'3px',color:'#3d5c35',marginBottom:'20px'}}>SHOP BY SIZE</p>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'14px',maxWidth:'500px',margin:'0 auto'}}>
            {['Girls 2–8','Teens 10–20'].map(size => (
              <div key={size} className="size-box" style={{border:'0.5px solid #c8d8c0',padding:'32px 16px',textAlign:'center',background:'rgba(255,255,255,0.8)',cursor:'pointer'}}>
                <div style={{fontSize:'22px',fontWeight:300,color:'#2c3e25',letterSpacing:'2px',marginBottom:'6px'}}>{size}</div>
                <div style={{fontSize:'10px',letterSpacing:'2px',color:'#3d5c35'}}>SHOP NOW</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section style={{margin:'0 40px 56px',padding:'40px 48px',background:'rgba(255,255,255,0.6)',border:'0.5px solid #c8d8c0',textAlign:'center'}}>
          ...
          <p style={{fontSize:'11px',color:'#3d5c35',letterSpacing:'2px',marginTop:'16px'}}>FOUNDED 1984 · MADE IN ITALY · FAMILY OWNED</p>
        </section>
        ...
        <footer style={{borderTop:'0.5px solid #c8d8c0',padding:'22px 40px',textAlign:'center'}}>
          ...
          <p style={{fontSize:'12px',color:'#2c3e25',letterSpacing:'1px',marginBottom:'6px'}}>
            <a href="https://www.instagram.com/alittlediff405" target="_blank" style={{color:'#2c3e25',textDecoration:'none'}}>Instagram: @alittlediff405</a>
          </p>
          <p style={{fontSize:'10px',color:'#3d5c35',letterSpacing:'1px'}}>© A Little Different · All rights reserved</p>
        </footer>
